        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
              ...
              {/* Free Trial */}
  <div className="rounded-3xl border border-indigo-200/80 bg-gradient-to-b from-indigo-50/80 via-white to-white p-8 shadow-xl shadow-indigo-100/60 hover:shadow-2xl hover:border-indigo-300 transition-all duration-300 flex flex-col justify-between group text-left">
    <div>
      <div>
        <div className="inline-flex items-center px-3 py-1 mb-4 text-xs font-bold uppercase tracking-wider text-indigo-600 bg-indigo-100 rounded-full border border-indigo-200">
          Free Trial
        </div>
        ...
        <p className="text-sm text-gray-500 mt-1.5">
          Explore the platform with no payment required
        </p>
      </div>
    ...
    <div className="pt-8">
      <Link to="/register-org" className="block w-full">
        <button
          type="button"
          className="w-full group flex items-center justify-center gap-2 py-3.5 font-bold text-base rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-200 hover:shadow-xl transition-all duration-300"
        >
          Start Free Trial
        </button>
      </Link>
