...
const Partners = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        'Could not save partner. Please try again.'
      );
    } finally {
      setSubmitting(false);
    }
    ...
    <DashboardLayout>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Partner organizations and the state
            of each relationship. New requests
            need Org Admin approval.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        {filtered.map((p) => (
          <div
            key={p.id}
            className="bg-white border border-gray-200 rounded-2xl shadow-lg p-5 flex flex-col gap-2"
          >
                ...
                p.status === 'Pending' && (
                  <>
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs font-semibold text-green-700 border border-green-200 rounded-lg px-3 py-1.5 hover:bg-green-50 transition"
                    >
                      <Check
                        size={14}
                      />
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs font-semibold text-red-600 border border-red-200 rounded-lg px-3 py-1.5 hover:bg-red-50 transition"
                    >
                      <Ban
                        size={14}
                      />
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Implementation Partner, Logistics"
                  className="w-full rounded-lg border border-gray-300 px-4 py-2 text-black focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
